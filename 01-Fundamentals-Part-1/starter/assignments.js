...
const descriptionNew = description; //oops! I've already done that
...
if (population > 33000000) {
  ...
  console.log(
    `${country}'s population is ${Math.round(
...
if (language === "English" && population < 50000000 && country !== "Island") {
...
population > 33
  ? console.log(`${country}'s population is above everage`)
